...
export default {
  ...
  createTeam: data => Api.post('/team/create', data), // 创建战队
  ...
  handleInvitation: data => Api.post('/team/inviteMe/handler', data), // 同意, 拒绝邀请
  ...
  updateSettings: data => Api.post('/team/setting', data), // 战队设置
